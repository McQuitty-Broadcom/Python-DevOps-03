...
- Your login: is mfwsuser3@demo.broadcom.com
...
- Your userid is CUST003.
- Your password CUST003.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS03 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS03 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST003.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST003.MARBLES.JCL(MARBCOPY)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-03.git`
